...
That is how making Sub-GHz external shipped broken: the app started importing
subghz_device_registry_* from firmware, which had never been exported because
an internal app does not need exports. See TASK-528 and TASK-530.
...
# exports and nothing else. This is what broke cli_subghz and cli_nfc when
# their libraries moved into an app.
CLI_PREFIX = "cli_"
